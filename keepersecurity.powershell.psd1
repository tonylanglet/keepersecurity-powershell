#
# Module manifest for module 'keepersecurity.powershell'
#
...
GUID = 'a790e55a-c04f-4eb0-9b6d-13585af4f3cd'
...
Description = 'This module is based on the Keeper Security application and the python SDK named KeeperCommander'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/tonylanglet/keepersecurity.powershell/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/tonylanglet/keepersecurity.powershell'
