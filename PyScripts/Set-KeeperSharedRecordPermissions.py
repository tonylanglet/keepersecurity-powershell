...
def main(argv):
    ...
    parser.add_argument('--share', dest='can_share', action='store_true', help='can re-share record')
    parser.add_argument('--write', dest='can_edit', action='store_true', help='can modify record')
