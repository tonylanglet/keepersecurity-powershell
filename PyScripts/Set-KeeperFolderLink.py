...
def main(argv):
    ...
    parser.add_argument('--can-reshare', dest='can_reshare', type=bool, help='anyone can reshare records')
    parser.add_argument('--can-edit', dest='can_edit', type=bool, help='anyone can edit records')
