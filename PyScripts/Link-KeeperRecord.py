...
# KEEPER COMMAND
def move_folder(recordSource, recordDestination, recordCanReshare, recordCanEdit, recordForce):
...
def main(argv):
    ...
    # Start function
    result = move_folder(recordSource, recordDestination, recordCanReshare, recordCanEdit, recordForce)
