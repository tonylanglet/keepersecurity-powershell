...
def main(argv):
    ...
    parser.add_argument('--record', type=str, action='store', help='Record uid', required=True)
    parser.add_argument('--format', dest='format', action='store', choices=['json','detail'], help='format json/detail', default='json')
